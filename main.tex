...
\titlebox{%
  ...
  application layer integrates a specialized AI inference module for real-time video processing. Experimental results demonstrate an average
...
\begin{minipage}{\columnwidth}
\centering
\captionof{table}{Hiệu năng suy luận của các mô-đun trong hệ thống}
\label{tab:inference}
\fontsize{7}{8.5}\selectfont
\setlength{\tabcolsep}{2.5pt}
\resizebox{\columnwidth}{!}{%
