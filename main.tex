...
\titlebox{%
  ...
  {\fontsize{9}{11}\selectfont Dao Van Vinh$^{1,\ast}$, Nguyen Thanh Xuan$^{1}$, Dao Phuc Dan$^{1}$}\\[3pt]
...
\titlebox{%
  ...
  {\fontsize{9}{11}\selectfont Đào Văn Vinh$^{1,\ast}$, Nguyễn Thanh Xuân$^{1}$, Đào Phúc Dân$^{1}$}\\[3pt]
  {\fontsize{8}{10}\selectfont\itshape
