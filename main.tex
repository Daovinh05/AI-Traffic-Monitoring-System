...
Bảng~\ref{tab:inference} trình bày thời gian suy luận và độ chính xác phân loại của từng mô-đun trong kiểm thử lab trên CPU với độ phân giải 640$\times$480. Pipeline xử lý tuần tự đạt tốc độ 2,16 FPS (462,37 ms/frame), trong đó các mô hình YOLOv8 chiếm phần lớn thời gian xử lý.
