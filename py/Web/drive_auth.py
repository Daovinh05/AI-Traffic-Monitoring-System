...
# MySQL config - Read from environment variables for Render deployment
...
def get_db_connection():
    try:
        ...
        # For local development, ssl can be None
        ssl_config = {
            'ca': '/etc/ssl/cert.pem' if os.environ.get('RENDER') else None
        }
        ...
        return pymysql.connect(
            ...
            charset='utf8mb4',
            ssl=ssl_config if ssl_config['ca'] else None
        )
...
if __name__ == '__main__':
    try:
        ...
        def open_browser():
            ...
            if not browser_opened and not os.environ.get('RENDER'):
